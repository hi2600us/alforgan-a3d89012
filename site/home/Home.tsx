...
const t = {
  ar: {
    ...
    heroTitle: "وقف الفرقان الخيري ودار النسائية لتحفيظ القرآن",
    ...
    aboutTitle: "وقف الفرقان الخيري ودار النسائية لتحفيظ القرآن",
      ...
      <section id="announcement" className="py-6 bg-[color:var(--emerald-deep)] text-[color:var(--sand)]">
        <div className="max-w-6xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="shrink-0 flex flex-wrap gap-2 justify-center">
            <a href="/halaqat-interest/" className="inline-flex px-5 py-2 rounded-full font-medium text-[color:var(--emerald-deep)] bg-[color:var(--sand)] hover:bg-white transition-colors text-sm">
              {isRtl ? "سجّل اهتمامك" : "Register interest"}
            </a>
            <a href="/recite/" className="inline-flex px-5 py-2 rounded-full font-medium border border-[color:var(--gold-soft)]/50 text-[color:var(--sand)] hover:bg-white/10 transition-colors text-sm">
              ...
              <div className="mt-8 rounded-xl border border-[color:var(--gold-soft)]/30 bg-black/20 backdrop-blur-sm p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3 text-sm">
                  ...
                  <div className="flex justify-between gap-4 border-b border-white/10 pb-2">
                    ...
                    <span className="font-display text-[color:var(--sand)] text-right">{isRtl ? "وقف الفرقان الخيري ودار النسائية لتحفيظ القرآن\u00a0" : "Alforgan Charitable Endowment"}</span>
                  </div>
